...
export const LOCAL_SQLITE_MIGRATIONS: readonly {
  ...
  },
  {
    ...
    name: "Rapports & Messages — role_documents and reference sequences",
    statements: [
      `CREATE TABLE IF NOT EXISTS role_documents (
        id TEXT PRIMARY KEY NOT NULL,
        reference_number TEXT UNIQUE,
  ...
  },
  {
    ...
    name: "Rapports & Messages — allow equipment_chief role category",
    statements: [
      ...
      `INSERT INTO role_documents__equipment_chief_v1 SELECT * FROM role_documents`,
