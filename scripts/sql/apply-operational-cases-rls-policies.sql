-- Fix operational case edit/create RLS failures.
...
DROP POLICY IF EXISTS "Authenticated can update operational_case_attachments" ON public.operational_case_attachments;
