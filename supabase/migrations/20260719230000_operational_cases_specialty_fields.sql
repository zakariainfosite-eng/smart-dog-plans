-- Specialty-specific operational case fields.
...
ALTER TABLE public.operational_cases
  ...
  ADD COLUMN IF NOT EXISTS object_count INTEGER CHECK (object_count IS NULL OR object_count > 0),
  ...
  ADD COLUMN IF NOT EXISTS banknote_count INTEGER CHECK (banknote_count IS NULL OR banknote_count >= 0),
  ADD COLUMN IF NOT EXISTS country TEXT;

ALTER TABLE public.operational_cases
  DROP CONSTRAINT IF EXISTS operational_cases_specialty_fields_check;
